...
首都政治中心，红墙黄顶，很大的太阳还有蒙蒙的雾霾，四合院。北京是一堆记忆，认知，知识的复合体。这就是组块。
组块最重要的作用就是便于我们记忆。我们无法记忆毫无关联的一大串数字。我们需要不断把新知识和已有的知识发生关联，整合，来进行记忆。
组块，就是将一系列的，相互关联的知识，打包，汇总。方便人类提取经验和知识，让我们产生思考，发散思维，迅速做出判断。

## 大脑处理信息概述：
组块，是长期记忆，知识的最小单元。而与之对应的，就是每天学到的零散的知识，也就是我们看了一篇文章之后的那些知识，那他们保存在哪里了呢？
...
## 学习方法
通过上面的分析我们知道，人脑形成长期记忆的关键是形成组块保存起来。因此我们学习任何东西的时候，其实归宿不是看过书就完了，那样你永远只能得到随风而去的临时记忆，
学习的核心是围绕构建组块。构建组块的唯一途径是不断复习。因此 学习 = 可复习的获取知识。也就是组块学习法。它分为前，中，后三个阶段。
...
1）组块是个啥？
2）是谁来负责将临时记忆转化成长期记忆的？这个过程的关键是什么？
2）组块学习法三个步骤是什么？

我个人因为平时需要学习很多的计算机知识，然而我又不是个学霸，不擅长逼着自己学习。因此我就在平时会思考学习的规律和方法，努力提升自己。但是方法仅仅是一种理论，他并无法直接解决现实的难题，
因此我写了一些个人管理的工具还有组块学习法的回忆提醒软件，来帮助我更好的运用这些学习理论。因为还在个人测试阶段，如果有需要可以私信我，开放后第一时间告知。
...
就拿Javascript举例，它本身的核心概念并不多，但是每一个都需要大量的练习，才能够完全理解，掌握。如果要想长期的记忆，你必须在脑子里面，一点点让知识形成关联。
我在学习前端知识的时候很有感触，他的知识脉络非常的复杂，涉及面很广，又很薄。因此面临的挑战是需要学习大量知识脉络并不清晰的知识。刚开始学的时候，觉得很像文科，你要了解很多东西。
渐渐地会发现，底层的抽象结构有相似之处，形成了关联，反而容易理解记忆。例如闭包，它本身的定义概念及其简单。（就像是北京这个词汇一样）但是你在js的世界里，到处都能看到他的应用，他的原理，他渐渐就不是一个名词，甚至不是一个套路，而是
